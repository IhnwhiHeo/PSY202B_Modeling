...
\urlstyle{same}
\hypersetup{
  pdftitle={{[}PSY202B Guest Lecture{]} Statistical Modeling in Psychological Sciences},
...
\hypertarget{about-guest-lectures}{%
\chapter{About guest lectures}\label{about-guest-lectures}}
